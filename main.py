...
import ExperimentSwitchTransfomer
...
if __name__ == '__main__':
    ...
    ExperimentSwitchTransfomer.add_subparser(subparsers, parents=[parent_parser])
...
# screen -dmS test bash -c "./venv/bin/torchrun --nproc-per-node 2 ./SwitchTransfomer-3/main.py train --DataPath /root/autodl-tmp/Data/ --GpuNum 2" # 训练 RTX 5090 * 2