...
from testing.ExpertSet_ import *
from testing.Transformer_  import *
from testing.SwitchTransformer_  import *
...
class Config():
    ...
    def load_model(self):
        ...
        transformer = Transformer(encoder,decoder,self.PadId,self.h,self.device)
